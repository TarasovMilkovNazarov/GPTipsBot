...
namespace GPTipsBot.Api
{
    public static class BotResponse
    {
        ...
        public static string SomethingWentWrongWithImageService = "Сервис генерации изображений находится в демо режиме. " +
        ...
        public static string PleaseWaitMsg = "Подождите, подготавливаю ответ...";
